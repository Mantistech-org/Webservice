...
import PerformancePage from '@/components/demo/pages/PerformancePage'
import ReviewManagement from '@/components/template/tabs/ReviewManagement'
import SEOOptimization from '@/components/demo/tabs/SEOOptimization'
import CalendarPage from '@/components/template/tabs/CalendarPage'
import SMSTextMarketing from '@/components/template/tabs/SMSTextMarketing'
...
export default function TemplateView({ hideBanner, skipGate }: { hideBanner?: boolean; skipGate?: boolean } = {}) {
