'use client'
// TEMPLATE ONLY — Standalone sidebar for the template/client view.
// Includes the Integrations tab which must never appear on the demo sidebar.
// Do not import this from components/demo/.
...
export default function TemplateSidebar({ expanded, activePage, onNavigate }: SidebarProps) {
  return (
    <aside
